      ...
      <table className="table-auto w-full min-w-3xl text-sm">
        <thead>
          <tr className="bg-gray-300 text-gray-700">
            ...
            <th className="font-semibold text-left p-3">videoLink</th>
        ...
        <tbody>
          {exercises.map((exercise) => (
            ...
            >
              ...
              <td className="p-3">{truncate(exercise.description)}</td>
              <td className="p-3">{truncate(exercise.category)}</td>
              <td className="p-3">{truncate(exercise.image)}</td>
              <td className="p-3">{truncate(exercise.videoLink)}</td>
